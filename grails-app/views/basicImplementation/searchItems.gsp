...
<body>
  ...
  <g:else>
	  ...
	  <g:form controller="basicImplementation" action="searchItemsCateg">
		...
		<p class="ch-form-row ch-form-required"><label for="file_name_radio">Radio:</label><input type="text" id="radio" name="radio" value=""/> <g:checkBox name="method" value="byRank"  checked = ""/> <label> by Rank</label>
