...
\begin{figure}[tb!]
\centering
\subfigure[\small Selecci\'on incremental]{\includegraphics[width=71.5mm]{imagenes/same_vs_different/16p_incremental.eps}}
\subfigure[\small Selecci\'on random]{\includegraphics[width=71.5mm]{imagenes/same_vs_different/16p_random.eps}}
		\caption{\small Estrategia de selecci\'on para 16 pivotes: mismos pivotes vs diferentes}
		\label{fig:same-vs-diff-16Pivotes}

\subfigure[\small Selecci\'on incremental]{\includegraphics[width=71.5mm]{imagenes/same_vs_different/64p_incremental.eps}}
\subfigure[\small Selecci\'on random]{\includegraphics[width=71.5mm]{imagenes/same_vs_different/64p_random.eps}}
...
\begin{figure}[t!]
\centering
\subfigure[\small T\'ecnica de selecci\'on de pivotes random]{\includegraphics[width=71.5mm]{imagenes/efecto_pivotes/g1_random_ep.eps}}
\subfigure[\small T\'ecnica de selecci\'on de pivotes incremental]{\includegraphics[width=71.5mm]{imagenes/efecto_pivotes/g1_incremental_ep.eps}}
		\caption{\small Efecto de la cantidad de pivotes sobre el ratio de comparaciones.}
		\label{fig:EP-g1}
\end{figure}
...
\begin{figure}[tb!]
\centering
\subfigure[\small T\'ecnica de selecci\'on de pivotes random]{\includegraphics[width=71.5mm]{imagenes/efecto_pivotes/g2_random_ep.eps}}
\subfigure[\small T\'ecnica de selecci\'on de pivotes incremental]{\includegraphics[width=71.5mm]{imagenes/efecto_pivotes/g2_incremental_ep.eps}}
		\caption{\small Efecto de la cantidad de pivotes sobre el ratio de comparaciones.}
		\label{fig:EP-g2}
\end{figure} 
...
\begin{figure}[tb!]
\centering
\subfigure[\small T\'ecnica de selecci\'on de pivotes random]{\includegraphics[width=71.5mm]{imagenes/efecto_pivotes/g3_random_ep.eps}}
\subfigure[\small T\'ecnica de selecci\'on de pivotes incremental]{\includegraphics[width=71.5mm]{imagenes/efecto_pivotes/g3_incremental_ep.eps}}
		\caption{\small Efecto de la cantidad de pivotes sobre el ratio de comparaciones.}
		\label{fig:EP-g3}
\end{figure}
...
\begin{figure}[tb!]
\centering
\subfigure[\small T\'ecnica de selecci\'on de pivotes random]{\includegraphics[width=71.5mm]{imagenes/efecto_pivotes/g4_random_ep.eps}}
\subfigure[\small T\'ecnica de selecci\'on de pivotes incremental]{\includegraphics[width=71.5mm]{imagenes/efecto_pivotes/g4_incremental_ep.eps}}
		\caption{\small Efecto de la cantidad de pivotes sobre el ratio de comparaciones.}
		\label{fig:EP-g4}
\end{figure}

Como conclusion se puede observar que para todas las bases de datos de los diferentes grupos a medida que aumenta el n\'umero de pivotes, el ratio de comparaciones es menor.\\
...
\begin{figure}[tb!]
\centering
\subfigure[\small T\'ecnica de selecci\'on de pivotes random]{\includegraphics[width=71.5mm]{imagenes/efecto_db/g1_random_edb.eps}}
\subfigure[\small T\'ecnica de selecci\'on de pivotes incremental]{\includegraphics[width=71.5mm]{imagenes/efecto_db/g1_incremental_edb.eps}}
		\caption{\small Efecto del tamaño de la base de datos sobre el ratio de comparaciones por pivotes.}
		\label{fig:EDB-g1}
\end{figure}
...
\begin{figure}[tb!]
\centering
\subfigure[\small T\'ecnica de selecci\'on de pivotes random]{\includegraphics[width=71.5mm]{imagenes/efecto_db/g2_random_edb.eps}}
\subfigure[\small T\'ecnica de selecci\'on de pivotes incremental]{\includegraphics[width=71.5mm]{imagenes/efecto_db/g2_incremental_edb.eps}}
		\caption{\small Efecto del tamaño de la base de datos sobre el ratio de comparaciones por pivotes.}
		\label{fig:EDB-g2}
\end{figure}
...
\begin{figure}[tb!]
\centering
\subfigure[\small T\'ecnica de selecci\'on de pivotes random]{\includegraphics[width=71.5mm]{imagenes/efecto_db/g3_random_edb.eps}}
\subfigure[\small T\'ecnica de selecci\'on de pivotes incremental]{\includegraphics[width=71.5mm]{imagenes/efecto_db/g3_incremental_edb.eps}}
		\caption{\small Efecto del tamaño de la base de datos sobre el ratio de comparaciones por pivotes.}
		\label{fig:EDB-g3}
\end{figure}
...
\begin{figure}[tb!]
\centering
\subfigure[\small T\'ecnica de selecci\'on de pivotes random]{\includegraphics[width=71.5mm]{imagenes/efecto_db/g4_random_edb.eps}}
\subfigure[\small T\'ecnica de selecci\'on de pivotes incremental]{\includegraphics[width=71.5mm]{imagenes/efecto_db/g4_incremental_edb.eps}}
		\caption{\small Efecto del tamaño de la base de datos sobre el ratio de comparaciones por pivotes.}
		\label{fig:EDB-g4}
\end{figure}
